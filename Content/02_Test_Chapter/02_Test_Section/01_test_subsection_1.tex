...
环境引用测试: \autoref{ax:test}, \autoref{hyp:test}, \autoref{mt:test}, \autoref{cri:test}, \autoref{prob:test}, \autoref{alg:test}, \autoref{conv:test}, \autoref{alr:test}, \autoref{sk:test}.
习题相关环境 (exercise/solution) 见本章章末「习题」Section.
